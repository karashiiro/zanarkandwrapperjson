...
// ServerLobbyIpcTypeCN - Server IPC Lobby Type Codes.
var ServerLobbyIpcTypeCN = map[string]uint16{
	"LobbyError":              0x0002,
...
// ClientLobbyIpcTypeCN - Client IPC Lobby Type Codes.
var ClientLobbyIpcTypeCN = map[string]uint16{
	"ReqCharList":       0x0003,
...
// ServerZoneIpcTypeCN - Server IPC Zone Type Codes.
var ServerZoneIpcTypeCN = map[string]uint16{
...
// ClientZoneIpcTypeCN - Client IPC Zone Type Codes.
var ClientZoneIpcTypeCN = map[string]uint16{
...
// ServerChatIpcTypeCN - Server IPC Chat Type Codes.
var ServerChatIpcTypeCN = map[string]uint16{
	//    Tell: 0x0064, // updated for sb
	"TellErrNotFound":  0x0066,
	"FreeCompanyEvent": 0x012C, // added 5.0
}

// ClientChatIpcTypeCN - Client IPC Chat Type Codes.
var ClientChatIpcTypeCN = map[string]uint16{
	"TellReq": 0x0064,
}
